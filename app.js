...
var incompleteTaskHolder=document.querySelector(".section__list_in-complete");//ul of #incompleteTasks
...
var createNewTaskElement=function(taskString){
    ...
    label.className='section__checkbox_text task-text';

    //Each elements, needs appending
    checkBox.type="checkbox";
    editInput.type="text";
    editInput.className="section__input_text task-text";
    ...
    deleteButtonImg.className="section__button_img"
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("section_edit-mode");
    ...
    listItem.classList.toggle("section_edit-mode")
